...
export default class Command extends BaseCommand {
    ...
    exec = async (M) => {
        const { open_issues_count, forks_count, stargazers_count, updated_at } = await this.client.util.fetch(
            `https://api.github.com/repos/AYUSH-PANDEY023/Maria-MD`
        )
        return void (await M.replyRaw({
            text: '*https://github.com/AYUSH-PANDEY023/Maria-MD.git*',
            contextInfo: {
                externalAdReply: {
                    ...
                    mediaType: 1,
                    mediaUrl: '',
                    sourceUrl: 'https://github.com/AYUSH-PANDEY023/Maria-MD.git',
